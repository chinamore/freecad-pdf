...
TRANSLATIONS = {
    ...
    "Load STEP...": "加载 STEP...",
    "Load a STEP (.step/.stp) 3D file": "加载 STEP (.step/.stp) 3D 文件",
    "Load STEP": "加载 STEP",
    "STEP Files (*.step *.stp)": "STEP 文件 (*.step *.stp)",
    "Loaded STEP: {v}": "已加载 STEP：{v}",
    "Projection": "投影",
    "Projection group (FRONT+TOP+RIGHT/LEFT)": "投影组（主视+俯视+左/右视）",
    "Projection group inserted (third-angle)": "已插入投影组（第三视角）",
    "Projection group inserted (first-angle)": "已插入投影组（第一视角）",
    "Insert a projected view (1st/3rd angle)": "插入投影视图（第一/第三视角）",
    "Insert a page template first.": "请先插入图纸模板。",
    "Projection angle: third-angle": "投影视角：第三视角",
    "Projection angle: first-angle": "投影视角：第一视角",
    "3rd angle": "第三视角",
    "Projection angle: 3rd (checked) / 1st": "投影视角：第三视角（选中）/ 第一视角",
    "Projection produced no geometry.": "投影未生成几何。",
    "Inserted {v} projection ({n} edges).": "已插入 {v} 投影（{n} 条边）。",
    "Text": "文字",
    "Balloon": "气球",
    "Leader line": "引线",
    "Length dimension": "长度标注",
    "Horiz. dimension": "水平标注",
    "Vert. dimension": "垂直标注",
    "Radius dimension": "半径标注",
    "Diameter dimension": "直径标注",
    "Angle dimension": "角度标注",
    "Centerline 2 lines": "两线中心线",
    "Centerline 2 points": "两点中心线",
    "Cosmetic line": "修饰线",
    "Cosmetic circle": "修饰圆",
    "TechDraw tool: {v}": "TechDraw 工具：{v}",
    "Content:": "内容：",
    "Radius": "半径",
    "Radius (mm):": "半径 (mm)：",
